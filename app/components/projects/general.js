      ...
      <section className="pageChunk my-card">
        ...
        <h2 className="subtitle is-size-6 project-subtitle">
          ...
          <div className="project-btn-container">
            ...
            <a
              className="button is-small project-btn"
              href="https://github.com/FractalVoyager"
              target="_blank"
            >
              Source Code
            </a>
        ...
        <Fold
          foldContent={
            <>
              <p className="inner-page-chunk">
                The language and application supports paramter and dynamical
                plane fractals, along with point orbit visualizations. The
                parameter plane is the complex plane when a function is iterated
                until a condition is met with respect to a fixed point. For
                example, z = z^2+c. It includes the paramter, c*, which changes
                with respect to the passed in point across the complex plane.
                {"\n\n"}The dynamical plane is the complex plane when a function
                is iterated until a condition is met with respect to a variable
                point, z, that changes with respect to the passed in point
                across the complex plane. For example, z = z^2 − 0.79 + 0.15i. A
                complex number’s orbit for a particular dynamical system is the
                value of the number after each iteration of the function.{"\n"}
              </p>
              <Fold
                foldContent={
                  <p className="inner-page-chunk">
